...
* Add ```position: relative;``` to .content and ```position: absolute; top: 0; right: 0;``` to .notice. 
    * Try to change the position of .content to relative then to fixed. What do you observed each time?
* The .content stays in place even after scrolling, and since the .notice is positioned relative to that, it also stays in place.
    * What do you observe on about the effect of z-index on .notice and .content boxes?
* The z-index affects the layering of the elements. If the z-index of .notice is higher than .content, it will appear in front of it, and if it's lower, it will appear underneath it.
